...
class MusicBrainzService(
    val albumCoversService: AlbumCoversService,
    val musicArtistRepository: MusicArtistRepository,
    ...
    override suspend fun getArtist(id: MBID): MusicArtist = run {
        ...
        val wikidata = wikiDataService.getEntityDataById(wikiDataEntityId)
        val wikipedia =
